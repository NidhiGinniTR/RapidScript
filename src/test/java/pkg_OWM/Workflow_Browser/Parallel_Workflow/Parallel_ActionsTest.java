package pkg_OWM.Workflow_Browser.Parallel_Workflow;
...
public class Parallel_ActionsTest extends Browsers {
	...
	@Test
	public void ParallelTemplate() throws IOException, InterruptedException {
		driver = InvokeDriver("Parallel");
